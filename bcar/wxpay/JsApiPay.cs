...
namespace WxPayAPI
{
    public class JsApiPay
    {
        ...
        /// </summary>
        private ControllerBase page {get;set;}
        ...
        public JsApiPay(ControllerBase page)
        {
            this.page = page;
        }
        ...
        */
        ...
        {
            if (!string.IsNullOrEmpty(page.Request.Query["code"]))
            {
                //获取code码，以获取openid和access_token
                string code = page.Request.Query["code"];
            ...
            {
                //构造网页授权获取code的URL
                string host = page.Request.Host.ToString();
	    ...
	    */
        ...
        public WxPayData GetUnifiedOrderResult()
        {
            //统一下单
            WxPayData data = new WxPayData();
            data.SetValue("body", "百变出车充值服务");
            data.SetValue("attach", "百变出车");
            data.SetValue("out_trade_no", WxPayApi.GenerateOutTradeNo());
            data.SetValue("total_fee", total_fee);
            data.SetValue("time_start", DateTime.Now.ToString("yyyyMMddHHmmss"));
            data.SetValue("time_expire", DateTime.Now.AddMinutes(10).ToString("yyyyMMddHHmmss"));
            data.SetValue("goods_tag", "百变出车");
	    ...
	    */
        public string GetEditAddressParameters()
	    {
            ...
            try
            {
                string host = page.Request.Host.ToString();
                string path = page.Request.Path;
                string queryString = page.Request.Host.Value;
